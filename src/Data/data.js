const data = [
  {
    id: 1,
    title: "Ten Tips For Aspiring Designer Beginners",
    description:
      "Luis Ouriach shared advice he wished he had when starting out in his career. In this second and last part of this series, Luis continues sharing tips that helped him grow and become a better designer throughout the years.",
    image: `images/search-result-1.png`,
    creationDate: "January 25, 2021",
    creator: "Luis Ouriach",
    tags: ["tag 1", "tag 2", "tag 3"],
    categories: ["business formation", "Graphic Designing"],
  },
  {
    id: 2,
    ...
    image: `images/search-result-3.png`,
    creationDate: "January 29, 2021",
    creator: "Daniel Don",
    tags: ["tag 1", "tag 2", "tag 3"],
    categories: ["business formation", "Graphic Designing", "Designer"],
  },
  {
    id: 3,
    ...
    image: `images/search-result-2.png`,
    creationDate: "Feb 04, 2021",
    creator: "Kate Kalcevich",
    tags: ["tag 1", "tag 2", "tag 3"],
    categories: ["Digital Agency", "Estate Plan", "Designer"],
  },
  {
    id: 4,
    ...
    image: `images/search-result-3.png`,
    creationDate: "Feb 11, 2021",
    creator: "Ahmad Shadeed",
    tags: ["tag 1", "tag 2", "tag 3"],
    categories: ["Graphics", "Graphic Designing", "Designer"],
  },
];
