            ...
            <div className="container mt-4">
              <div className="row flex-column align-items-center flex-md-row">
                ...
                <div className="col-lg-5 col-md-6 col-sm-12 ms-auto">
                  <h1
                    className="heading-1 mt-4 mt-md-5 text-center text-md-start"
                    style={{ color: "#333434" }}
                  >
        ...
        <div className="about__container py-md-5">
          <div className="container">
            <div className="row justify-content-center">
              ...
              <p className="paragraph mt-3 text-center text-md-start w-md-75">
              ...
              <p className="paragraph mt-3 w-md-75 text-center text-md-start">
              ...
              <p className="paragraph p-light mt-4 w-md-75 fw-normal mb-5 text-center text-md-start">
                ...
                visit us at{" "}
                <a href="#" className="p-link" style={{ color: "#4dad90" }}>
