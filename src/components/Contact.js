...
const BusinessFormation = (props) => {
  return (
    <>
      <div className="contact-us__hero bg-white">
        <div className="pt-4 pt-md-5" style={{ overflow: "hidden" }}>
          <div className="row position-relative">
            <div className="col-md-6 col-sm-12">
              <div className="row mb-4 mb-md-0">
                <h1 className="heading-1 bg-white text-center">Contact Us</h1>
              </div>
            </div>
            <div className="col-md-6 col-sm-12">
              <img
      ...
      <main>
        <div className="faq__container py-5 bg-white">
          <div className="container contact__container">
            <h2 className="heading-2 text-center">
              Frequently asked questions
            </h2>
            <h3 className="heading-3 mt-5 d-flex align-items-center">
              <span className="circle green d-inline-block me-2">&nbsp;</span>
              Top questions
            </h3>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="headingOne">
                  ...
                  >
                    ...
                    <img src="./images/chevreon.png" alt="chevreon" />
                  </button>
                </h2>
                <div
                  id="collapseOne"
