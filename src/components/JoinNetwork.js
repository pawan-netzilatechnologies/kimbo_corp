  ...
  return (
    <>
      ...
      <section className="guidance-section">
        <div className="container">
          <div className="row align-items-start guidance-card">
            ...
            <div className="col-md-6 order-first order-md-0 my-1 my-md-0">
          ...
          <div className="row align-items-start guidance-card">
            ...
            <div className="col-md-6">
              <h2 className="h2 mb-4">How we help grow your practice</h2>
      ...
      <section className="network-form">
        <div className="container">
          <h2 className="h2 my-5 text-center form-title">
