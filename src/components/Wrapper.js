...
const Wrapper = (props) => {
  ...
  return (
    <>
      <header
        className={`header_new py-2 position-relative ${
          window.location.pathname !== "/" ? "bg-white shadow-sm" : ""
        }`}
      >
        <nav
          className="
        ...
        >
          <div className="container d-flex mobile-grid gap-2">
            ...
            <div className="socials-container  d-flex align-items-center gap-2 gap-lg-3 w-50">
              ...
              <a
                href="#"
                className="d-flex align-items-center shadow justify-content-center"
              >
